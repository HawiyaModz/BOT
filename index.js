import { RIMURU_CORE_CONFIG, RIMURU_DEVELOPER } from "./rimuru.js";
...
import { startOrderPoller } from "./src/lib/orderPoller.js";
import { server as webGatewayServer } from "./src/lib/rimuru-web-gateway.js";
import {
  logger,
  c,
  playBootSequence,
...
function setupAntiCrash() {
  ...
  process.on("SIGINT", async () => {
    ...
    try { webGatewayServer?.close(); } catch {}
    process.exit(0);
  });
...
async function main() {
  await playBootSequence({
    ...
    developer: RIMURU_DEVELOPER || "Developer",
